...
public class DocumentDAO {
    ...
    public static ArrayList getAllDocumentFromAuthor(String authorName) {
        ...
        String query = String.format(
                "SELECT d.* FROM %s AS d " +
                        ...
                        "JOIN authors AS a ON da.author_id = a.author_id " +
                        "WHERE a.name = '%s'",
                MAIN_TABLE, DOCUMENT_AUTHOR_TABLE, authorName
        );
    ...
    public static ArrayList getAllDocumentFromCategory(String category) {
        ...
        String query = String.format(
                "SELECT d.* FROM %s AS d " +
                        ...
                        "WHERE c.category = '%s'",
                MAIN_TABLE, DOCUMENT_CATEGORY_TABLE, "categories", category
        );
    ...
    public static void addDocument(Document doc) {
        ...
        for (Category category : doc.getCategories()) {
            String categoryId = category.getId(); // Lấy ID từ Category
        ...
        for (Author author : doc.getAuthors()) {
            String authorId = author.getId(); // Lấy ID từ Author
